...
void loop() {
  ...
  moveAllServosSmoothly(270, 270, 270, 270, 30);  // Move all servos to 180 degrees with stepDelay of 10ms
  delay(2000);  // Wait for 2 seconds

  // Move all servos back to 0 degrees
  moveAllServosSmoothly(0, 0, 0, 0, 0);  // Move all servos back to 0 degrees
  delay(2000);  // Wait for 2 seconds
}
